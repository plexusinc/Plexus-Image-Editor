...
public interface OnPhotoEditorListener {
    ...
    /**
     * This is a callback when user adds any view on the {@link PlexusImageEditorView} it can be
    ...
    /**
     * This is a callback when user remove any view on the {@link PlexusImageEditorView} it happens when usually
