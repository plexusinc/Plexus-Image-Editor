...
/**
 * <p>
 * This class is used to wrap the styles to apply on the TextView on {@link PlexusImageEditor#addText(String, TextStyleBuilder)} and {@link PlexusImageEditor#editText(View, String, TextStyleBuilder)}
 * </p>
 */
public class TextStyleBuilder {
    ...
    /**
     * Enum to maintain current supported style properties used on on {@link PlexusImageEditor#addText(String, TextStyleBuilder)} and {@link PlexusImageEditor#editText(View, String, TextStyleBuilder)}
     */
