package com.plexus.photo_editor.views;
...
import com.plexus.photo_editor.CustomEffect;
import com.plexus.photo_editor.OnSaveBitmap;
import com.plexus.photo_editor.PlexusImageFilter;
import com.plexus.photo_editor.R;
...
public class PlexusImageEditorView extends RelativeLayout {
    ...
    public PlexusImageEditorView(Context context) {
        super(context);
        init(null);
    }

    public PlexusImageEditorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public PlexusImageEditorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public PlexusImageEditorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(@Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.PlexusImageEditorView);
            Drawable imgSrcDrawable = a.getDrawable(R.styleable.PlexusImageEditorView_photo_src);
        ...
        mImgSource.setOnImageChangedListener(new FilterImageView.OnImageChangedListener() {
            ...
            public void onBitmapLoaded(@Nullable Bitmap sourceBitmap) {
                mImageFilterView.setFilterEffect(PlexusImageFilter.NONE);
